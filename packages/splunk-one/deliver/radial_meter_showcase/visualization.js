...
define(['api/SplunkVisualizationBase', './radialMeterArc'], function (
    ...
    var NS = 'display.visualizations.custom.so_BUI_pickulationts.radial_meter_showcase.';
    var SHOWCASE_DEFAULTS = {};
    SHOWCASE_DEFAULTS[NS + 'mainColor'] = '#f7bc38';
    SHOWCASE_DEFAULTS[NS + 'maxValue'] = '100';
    SHOWCASE_DEFAULTS[NS + 'backgroundColor'] = '#ffffff';
    var WIDTH = arc.WIDTH;
