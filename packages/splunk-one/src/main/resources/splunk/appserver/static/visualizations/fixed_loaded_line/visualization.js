define(["api/SplunkVisualizationBase"], (__WEBPACK_EXTERNAL_MODULE__879__) => { return /******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
function normalizeTimes(rawTimes, len) {
  ...
  var timeLike = ok >= Math.max(2, Math.floor(len * 0.7));
  return {
    ms: out,
    timeLike: timeLike
  };
...
function formatMajor(v, unit) {
  ...
  return {
    majorText: v.toLocaleString(undefined, {
      maximumFractionDigits: 2
    }),
...
function formatDelta(d) {
  ...
  var arrow = d >= 0 ? "\u25B2" : "\u25BC";
  return "".concat(arrow, " ").concat(d.toLocaleString(undefined, {
    maximumFractionDigits: 2
  }));
}
...
function downsample(values, times, maxPoints) {
  ...
  if (!cap || values.length <= cap) return {
    values: values,
    times: times
  };
...
function buildPath(values, width, height, _ref) {
  var padLeft = _ref.padLeft,
    padRight = _ref.padRight,
    padTop = _ref.padTop,
    padBottom = _ref.padBottom,
    min = _ref.min,
    max = _ref.max;
  var innerW = Math.max(1, width - padLeft - padRight);
  var innerH = Math.max(1, height - padTop - padBottom);
  var n = values.length;
  if (n < 2) return '';
  var xStep = innerW / (n - 1);
  ...
  return values.map(function (v, i) {
    return "".concat(i === 0 ? 'M' : 'L', " ").concat(toX(i).toFixed(2), " ").concat(toY(v).toFixed(2));
  }).join(' ');
}
function computeAnomalies(values, mode, sensitivity) {
  var m = mode || 'none';
  var s = Number.isFinite(Number(sensitivity)) ? Number(sensitivity) : 3;
  ...
  if (m === 'pctChange') {
    for (var i = 1; i < values.length; i += 1) {
      ...
      var pct = Math.abs((cur - prev) / prev);
  ...
  var deltas = [];
  for (var _i = 1; _i < values.length; _i += 1) {
    var d = values[_i] - values[_i - 1];
  ...
  var varN = deltas.reduce(function (acc, d) {
    return acc + (d - mean) * (d - mean);
  }, 0) / deltas.length;
  var sd = Math.sqrt(varN) || 0;
  if (!sd) return flags;
  for (var _i2 = 1; _i2 < values.length; _i2 += 1) {
    var _d = values[_i2] - values[_i2 - 1];
    if (!Number.isFinite(_d)) continue;
    var z = Math.abs((_d - mean) / sd);
    if (z >= s) flags[_i2] = true;
  }
  return flags;
}
function buildSearchUrl(_ref2) {
  var earliestSec = _ref2.earliestSec,
    latestSec = _ref2.latestSec,
    query = _ref2.query;
  var q = query || '*';
  ...
  return "/app/search/search?".concat(params.toString());
}
function LineChart(_ref3) {
  var values = _ref3.values,
    times = _ref3.times,
    series = _ref3.series,
    comparisonSeries = _ref3.comparisonSeries,
    _ref3$width = _ref3.width,
    width = _ref3$width === void 0 ? 400 : _ref3$width,
    _ref3$height = _ref3.height,
    height = _ref3$height === void 0 ? 105 : _ref3$height,
    min = _ref3.min,
    max = _ref3.max,
    _ref3$stroke = _ref3.stroke,
    stroke = _ref3$stroke === void 0 ? 'rgba(255,255,255,0.95)' : _ref3$stroke,
    _ref3$strokeWidth = _ref3.strokeWidth,
    strokeWidth = _ref3$strokeWidth === void 0 ? 2 : _ref3$strokeWidth,
    _ref3$background = _ref3.background,
    background = _ref3$background === void 0 ? '#0B1F3B' : _ref3$background,
    _ref3$goodColor = _ref3.goodColor,
    goodColor = _ref3$goodColor === void 0 ? '#01417F' : _ref3$goodColor,
    _ref3$badColor = _ref3.badColor,
    badColor = _ref3$badColor === void 0 ? '#DFA611' : _ref3$badColor,
    _ref3$textColor = _ref3.textColor,
    textColor = _ref3$textColor === void 0 ? '#FFFFFF' : _ref3$textColor,
    unit = _ref3.unit,
    subheader = _ref3.subheader,
    _ref3$showMajor = _ref3.showMajor,
    ...
    unitScale = _ref3$unitScale === void 0 ? 0.6 : _ref3$unitScale,
    _ref3$showHover = _ref3.showHover,
    ...
    thresholdShade = _ref3$thresholdShade === void 0 ? 'rgba(0,0,0,0.12)' : _ref3$thresholdShade,
    target = _ref3.target,
    _ref3$targetStroke = _ref3.targetStroke,
    targetStroke = _ref3$targetStroke === void 0 ? 'rgba(255,255,255,0.5)' : _ref3$targetStroke,
    _ref3$smoothing = _ref3.smoothing,
    smoothing = _ref3$smoothing === void 0 ? 'none' : _ref3$smoothing,
    _ref3$smaWindow = _ref3.smaWindow,
    smaWindow = _ref3$smaWindow === void 0 ? 3 : _ref3$smaWindow,
    maxPoints = _ref3.maxPoints,
    _ref3$anomalyMode = _ref3.anomalyMode,
    anomalyMode = _ref3$anomalyMode === void 0 ? 'none' : _ref3$anomalyMode,
    _ref3$anomalySensitiv = _ref3.anomalySensitivity,
    anomalySensitivity = _ref3$anomalySensitiv === void 0 ? 3 : _ref3$anomalySensitiv,
    _ref3$drilldown = _ref3.drilldown,
    drilldown = _ref3$drilldown === void 0 ? false : _ref3$drilldown,
    drilldownQuery = _ref3.drilldownQuery,
    _ref3$showXAxis = _ref3.showXAxis,
    showXAxis = _ref3$showXAxis === void 0 ? false : _ref3$showXAxis,
    _ref3$padLeft = _ref3.padLeft,
    padLeft = _ref3$padLeft === void 0 ? 12 : _ref3$padLeft,
    _ref3$padRight = _ref3.padRight,
    padRight = _ref3$padRight === void 0 ? 12 : _ref3$padRight,
    _ref3$padTop = _ref3.padTop,
    padTop = _ref3$padTop === void 0 ? 10 : _ref3$padTop,
    _ref3$padBottom = _ref3.padBottom,
    padBottom = _ref3$padBottom === void 0 ? 18 : _ref3$padBottom,
    emptyText = _ref3.emptyText;
  var normalized = (0,react.useMemo)(function () {
    var baseSeries = Array.isArray(series) && series.length ? series : [{
      id: 'main',
      label: '',
      values: Array.isArray(values) ? values : [],
      color: stroke
    }];
    var mainNums = toFiniteNumbers(baseSeries[0] && baseSeries[0].values || []);
    var len = mainNums.length;
    var rawTimes = Array.isArray(times) ? times.slice(0, len) : mainNums.map(function (_, i) {
      return i;
    });
    var _normalizeTimes = normalizeTimes(rawTimes, len),
      ms = _normalizeTimes.ms,
      timeLike = _normalizeTimes.timeLike;
    var mapped = baseSeries.map(function (s) {
      return {
    ...
    var comp = Array.isArray(comparisonSeries) ? comparisonSeries.map(function (s) {
      return {
        id: s.id || s.label || 'cmp',
        label: s.label || s.id || '',
  ...
  var _useMemo = (0,react.useMemo)(function () {
    ...
    majorText = _useMemo.majorText,
    unitText = _useMemo.unitText;

  // Reduce padding when header is visible so the chart isn't cramped.
  var effPadLeft = showMajor ? Math.min(padLeft, 10) : padLeft;
  var effPadRight = showMajor ? Math.min(padRight, 10) : padRight;
  var effPadTop = showMajor ? Math.min(padTop, 2) : padTop;
  var effPadBottom = showMajor ? Math.min(padBottom, 12) : padBottom;
  var processed = (0,react.useMemo)(function () {
    var out = normalized.series.map(function (s) {
      var v = s.values.slice();
      if (smoothing === 'sma') v = sma(v, smaWindow);
      var ds = downsample(v, normalized.times, maxPoints);
      return _objectSpread(_objectSpread({}, s), {}, {
        values: ds.values,
        times: ds.times
      });
    });
    var cmp = normalized.comparison && normalized.comparison.map(function (s) {
      var v = s.values.slice();
      if (smoothing === 'sma') v = sma(v, smaWindow);
      var ds = downsample(v, normalized.times, maxPoints);
      return _objectSpread(_objectSpread({}, s), {}, {
    ...
    var len = out[0] ? out[0].values.length : 0;
    var timesUsed = out[0] ? out[0].times : [];
    var _normalizeTimes2 = normalizeTimes(timesUsed, len),
      ms = _normalizeTimes2.ms,
      timeLike = _normalizeTimes2.timeLike;
    return {
      series: out,
      comparison: cmp,
      times: timesUsed,
  ...
  var paths = (0,react.useMemo)(function () {
    return processed.series.map(function (s) {
      return {
        id: s.id,
        color: s.color,
  ...
  var cmpPaths = (0,react.useMemo)(function () {
    return (processed.comparison || []).map(function (s) {
      return {
        id: s.id,
        color: s.color,
        d: buildPath(s.values, width, chartH, {
  ...
  var anomalyFlags = (0,react.useMemo)(function () {
    var main = paths[0] ? paths[0].values : [];
  ...
  var toX = (0,react.useCallback)(function (i) {
    return effPadLeft + i * xStep;
  }, [effPadLeft, xStep]);
  var toY = (0,react.useCallback)(function (v) {
    var innerH = Math.max(1, chartH - effPadTop - effPadBottom);
  ...
  var hx = hoverIdx != null ? toX(hoverIdx) : 0;
  var hoverPrimary = paths[0] ? paths[0].values[hoverIdx] : NaN;
  var hy = hoverIdx != null ? toY(hoverPrimary) : 0;
  var hoverTime = hoverIdx != null ? formatTimeForHover(processed.times[hoverIdx], processed.ms[hoverIdx], processed.timeLike) : '';
  var hoverValue = hoverIdx != null ? formatValue(hoverPrimary) : '';

  // X ticks (minimal)
  var ticks = (0,react.useMemo)(function () {
    if (!showXAxis || !processed.timeLike || processed.ms.length < 2) return [];
    var count = 4;
    var idxs = Array.from({
      length: count
    }, function (_, i) {
      return Math.round(i * (processed.ms.length - 1) / (count - 1));
    });
    return idxs.map(function (i) {
      var _processed$times$i;
      return {
        idx: i,
        x: toX(i),
        label: Number.isFinite(processed.ms[i]) ? new Date(processed.ms[i]).toLocaleTimeString(undefined, {
          hour: '2-digit',
          minute: '2-digit'
        }) : String((_processed$times$i = processed.times[i]) !== null && _processed$times$i !== void 0 ? _processed$times$i : '')
      };
    });
  ...
  return /*#__PURE__*/react.createElement("div", {
  ...
  }, majorText, unitText ? /*#__PURE__*/react.createElement("span", {
    style: {
      fontSize: "".concat(unitScale, "em"),
      fontWeight: 600,
      marginLeft: 2,
      opacity: 0.95
    }
    ...
    fill: thresholdShade
  }) : null, thHi != null ? /*#__PURE__*/react.createElement("rect", {
    x: effPadLeft,
    y: Math.max(0, yFor(thHi)),
    width: Math.max(0, width - effPadLeft - effPadRight),
    height: Math.max(0, chartH - effPadBottom - yFor(thHi)),
    fill: thresholdShade
  }) : null, yTarget != null ? /*#__PURE__*/react.createElement("line", {
    x1: effPadLeft,
    y1: yTarget,
  ...
  }), anomalyFlags.map(function (flag, i) {
    if (!flag) return null;
    var x = toX(i);
    var y = yFor(paths[0].values[i]);
    return /*#__PURE__*/react.createElement("polygon", {
      key: "an-".concat(i),
      points: "".concat(x, ",").concat(y - 6, " ").concat(x - 5, ",").concat(y + 4, " ").concat(x + 5, ",").concat(y + 4),
      fill: "rgba(255,255,255,0.85)",
      opacity: 0.9
    });
  }), ticks.map(function (t) {
    return /*#__PURE__*/react.createElement("text", {
      key: "tick-".concat(t.idx),
      x: t.x,
      y: chartH - 2,
      textAnchor: "middle",
  ...
  }), showHover && hoverIdx != null ? /*#__PURE__*/react.createElement("g", {
    style: {
      pointerEvents: 'none'
    }
  }, /*#__PURE__*/react.createElement("line", {
  ...
  }, hoverValue), unitText ? /*#__PURE__*/react.createElement("span", null, unitText) : null, hoverTime ? /*#__PURE__*/react.createElement("span", {
    style: {
      opacity: 0.9
    }
  ...
  }, hoverValue, unitText || '', anomalyFlags[hoverIdx] ? /*#__PURE__*/react.createElement("span", {
    style: {
      marginLeft: 6,
      opacity: 0.9
    }
  }, "(anomaly)") : null), hoverTime ? /*#__PURE__*/react.createElement("div", {
    style: {
      opacity: 0.88,
      marginTop: 2
    }
...
function FixedLoadedLineApp_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function FixedLoadedLineApp_unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return FixedLoadedLineApp_arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? FixedLoadedLineApp_arrayLikeToArray(r, a) : void 0; } }
function FixedLoadedLineApp_arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
function FixedLoadedLineApp_iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
function FixedLoadedLineApp_arrayWithHoles(r) { if (Array.isArray(r)) return r; }


function FixedLoadedLineApp(_ref) {
  var _ref$values = _ref.values,
    values = _ref$values === void 0 ? [] : _ref$values,
    _ref$times = _ref.times,
    times = _ref$times === void 0 ? [] : _ref$times,
    comparisonSeries = _ref.comparisonSeries,
    min = _ref.min,
    max = _ref.max,
    _ref$stroke = _ref.stroke,
    stroke = _ref$stroke === void 0 ? 'rgba(255,255,255,0.95)' : _ref$stroke,
    _ref$strokeWidth = _ref.strokeWidth,
    strokeWidth = _ref$strokeWidth === void 0 ? 2 : _ref$strokeWidth,
    _ref$background = _ref.background,
    background = _ref$background === void 0 ? '#0B1F3B' : _ref$background,
    ...
    subheader = _ref$subheader === void 0 ? '' : _ref$subheader,
    _ref$smoothing = _ref.smoothing,
    smoothing = _ref$smoothing === void 0 ? 'none' : _ref$smoothing,
    _ref$smaWindow = _ref.smaWindow,
    smaWindow = _ref$smaWindow === void 0 ? 3 : _ref$smaWindow,
    maxPoints = _ref.maxPoints,
    thresholdMin = _ref.thresholdMin,
    thresholdMax = _ref.thresholdMax,
    target = _ref.target,
    _ref$anomalyMode = _ref.anomalyMode,
    anomalyMode = _ref$anomalyMode === void 0 ? 'none' : _ref$anomalyMode,
    _ref$anomalySensitivi = _ref.anomalySensitivity,
    anomalySensitivity = _ref$anomalySensitivi === void 0 ? 3 : _ref$anomalySensitivi,
    _ref$drilldown = _ref.drilldown,
  ...
  var _useState = (0,react.useState)({
    ...
    _useState2 = FixedLoadedLineApp_slicedToArray(_useState, 2),
    size = _useState2[0],
...
function mountViz(el, props) {
  ...
  root.render(/*#__PURE__*/react.createElement(FixedLoadedLineApp, props));
}
...
/* harmony default export */ const visualization_amd = (SplunkVisualizationBase_default().extend({
  getInitialDataParams: function getInitialDataParams() {
    return {
      outputMode: (SplunkVisualizationBase_default()).COLUMN_MAJOR_OUTPUT_MODE,
      count: 5000
    };
  },
  formatData: function formatData(rawData) {
