...
function sparkBounds(minIn, maxIn) {
  ...
  var hi = parseFloat(String(maxIn), 10);
  var loN = Number.isFinite(lo) ? lo : 0;
  var hiN = Number.isFinite(hi) ? hi : 100;
  if (loN > hiN) {
    var t = loN;
    loN = hiN;
    hiN = t;
...
function sparkPath(values, w, h, padL, padR, padT, padB, vmin, vmax) {
  ...
  for (var i = 0; i < n; i += 1) {
    ...
    parts.push("".concat(i === 0 ? 'M' : 'L').concat(x.toFixed(1), " ").concat(y.toFixed(1)));
  }
  return parts.join(' ');
}
...
function VizApp(_ref) {
  var _ref$values = _ref.values,
    values = _ref$values === void 0 ? [] : _ref$values,
    _ref$sparkMin = _ref.sparkMin,
    sparkMin = _ref$sparkMin === void 0 ? 0 : _ref$sparkMin,
  ...
  var _useMemo = (0,react.useMemo)(function () {
    ...
    last = _useMemo.last,
    delta = _useMemo.delta,
    bg = _useMemo.bg,
    safeText = _useMemo.safeText,
    safeStroke = _useMemo.safeStroke;
  var majorText = (0,react.useMemo)(function () {
    if (!Number.isFinite(last)) {
      return '—';
    }
    return last.toLocaleString(undefined, {
      maximumFractionDigits: 2
    }) + String(unit || '');
  }, [last, unit]);
  var trendText = (0,react.useMemo)(function () {
    if (!Number.isFinite(delta)) {
      return '—';
    }
    var arrow = delta >= 0 ? "\u25B2 " : "\u25BC ";
    return arrow + delta.toLocaleString(undefined, {
      maximumFractionDigits: 2
    });
  }, [delta]);
  var d = (0,react.useMemo)(function () {
    return sparkPath(nums, 360, 28, 4, 4, 2, 2, scale.min, scale.max);
  }, [nums, scale.min, scale.max]);
  if (nums.length === 0) {
    return /*#__PURE__*/react.createElement("div", {
      className: "splunk-one-fixed-single-value-react-viz__err"
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "splunk-one-fixed-single-value-react-viz__header"
  }, subheader) : null, /*#__PURE__*/react.createElement("div", {
    className: "splunk-one-fixed-single-value-react-viz__body"
  }, /*#__PURE__*/react.createElement("div", {
    className: "splunk-one-fixed-single-value-react-viz__major"
  }, majorText), /*#__PURE__*/react.createElement("div", {
    className: "splunk-one-fixed-single-value-react-viz__trend"
  }, trendText), /*#__PURE__*/react.createElement("div", {
    className: "splunk-one-fixed-single-value-react-viz__spark"
  ...
  }, /*#__PURE__*/react.createElement("title", null, "sparkline"), /*#__PURE__*/react.createElement("path", {
    d: d,
    fill: "none",
    stroke: safeStroke,
    strokeWidth: "2",
...
;// ./src/main/webapp/visualizations/fixed_single_value_react/vizMount.jsx
...
function mountViz(el, props) {
  ...
  root.render(/*#__PURE__*/react.createElement(VizApp, props));
}
