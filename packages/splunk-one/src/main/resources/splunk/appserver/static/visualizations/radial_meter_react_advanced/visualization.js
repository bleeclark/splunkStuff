...
var ReactPropTypesSecret = __webpack_require__(848);
...
;// ./src/main/webapp/lib/radialMeterArc.mjs
/**
...
;// ./src/main/webapp/components/visualizations/AdvancedRadialMeter.jsx
...
function polarLine(angle, inner, outer) {
  var a = pointAt(angle, inner);
  var b = pointAt(angle, outer);
  return {
    x1: a.x,
    y1: a.y,
    x2: b.x,
...
function AdvancedRadialMeter(_ref) {
  var _ref$value = _ref.value,
    value = _ref$value === void 0 ? 73 : _ref$value,
    _ref$maxValue = _ref.maxValue,
    maxValue = _ref$maxValue === void 0 ? 100 : _ref$maxValue,
    _ref$target = _ref.target,
    target = _ref$target === void 0 ? 80 : _ref$target,
    _ref$warningAt = _ref.warningAt,
    warningAt = _ref$warningAt === void 0 ? 55 : _ref$warningAt,
    _ref$criticalAt = _ref.criticalAt,
    criticalAt = _ref$criticalAt === void 0 ? 30 : _ref$criticalAt,
    _ref$invertStatus = _ref.invertStatus,
    invertStatus = _ref$invertStatus === void 0 ? false : _ref$invertStatus,
    _ref$title = _ref.title,
    title = _ref$title === void 0 ? 'Capacity' : _ref$title,
    _ref$subtitle = _ref.subtitle,
    subtitle = _ref$subtitle === void 0 ? 'Current utilization' : _ref$subtitle,
    _ref$unit = _ref.unit,
    ...
    textColor = _ref$textColor === void 0 ? '#303B46' : _ref$textColor,
    _ref$trackColor = _ref.trackColor,
    trackColor = _ref$trackColor === void 0 ? '#D9DEE3' : _ref$trackColor,
    _ref$lowColor = _ref.lowColor,
    lowColor = _ref$lowColor === void 0 ? '#D94E4E' : _ref$lowColor,
    _ref$mediumColor = _ref.mediumColor,
    mediumColor = _ref$mediumColor === void 0 ? '#DFA611' : _ref$mediumColor,
    _ref$highColor = _ref.highColor,
    highColor = _ref$highColor === void 0 ? '#2E9E6F' : _ref$highColor,
    _ref$needleColor = _ref.needleColor,
    needleColor = _ref$needleColor === void 0 ? '#243447' : _ref$needleColor,
    _ref$width = _ref.width,
    width = _ref$width === void 0 ? 320 : _ref$width,
    _ref$height = _ref.height,
    height = _ref$height === void 0 ? 250 : _ref$height;
  var safeMax = Number.isFinite(maxValue) && maxValue > 0 ? maxValue : 100;
  var safeValue = clamp(Number(value), 0, safeMax);
  var safeTarget = clamp(Number(target), 0, safeMax);
  var safeWarning = clamp(Number(warningAt), 0, safeMax);
  var safeCritical = clamp(Number(criticalAt), 0, safeMax);
  var percent = safeMax > 0 ? safeValue / safeMax * 100 : 0;
  var status = statusFor(safeValue, safeWarning, safeCritical, invertStatus);
  var targetDelta = safeValue - safeTarget;
  var geometry = (0,react.useMemo)(function () {
    var segments = invertStatus ? [{
      from: 0,
      to: safeWarning,
      color: highColor
    }, {
    ...
    for (var i = 0; i <= 10; i += 1) {
      var tickValue = safeMax / 10 * i;
      var angle = valueToAngle(tickValue, safeMax);
      ticks.push({
        value: tickValue,
        major: i % 5 === 0,
  ...
  }, [highColor, invertStatus, lowColor, mediumColor, safeCritical, safeMax, safeTarget, safeValue, safeWarning]);
  var needleEnd = pointAt(geometry.valueAngle, 63);
  var targetLine = polarLine(geometry.targetAngle, 62, 99);
  var minLabel = pointAt(ARC_START, 110);
  var maxLabel = pointAt(ARC_END, 110);
  return /*#__PURE__*/react.createElement("div", {
    ...
    width: width,
    height: height,
    viewBox: "0 0 ".concat(WIDTH, " ").concat(HEIGHT + 34),
    role: "img",
    "aria-label": "".concat(title, " radial meter"),
    style: {
      display: 'block',
      maxHeight: '100%',
      maxWidth: '100%'
    ...
    transform: "translate(".concat(WIDTH / 2, ", ").concat(HEIGHT / 2 + 6, ")")
  }, /*#__PURE__*/react.createElement("path", {
    d: describeArc(0, 0, 66, 92, ARC_START, ARC_END),
    fill: trackColor
  }), geometry.segments.map(function (segment) {
    return /*#__PURE__*/react.createElement("path", {
      key: "".concat(segment.from, "-").concat(segment.to),
      d: describeArc(0, 0, 68, 90, valueToAngle(segment.from, safeMax), valueToAngle(segment.to, safeMax)),
      fill: segment.color,
      opacity: 0.24
    });
  }), /*#__PURE__*/react.createElement("path", {
    d: describeArc(0, 0, 70, 86, ARC_START, geometry.valueAngle),
    fill: status.color
  }), geometry.ticks.map(function (tick) {
  ...
  }), /*#__PURE__*/react.createElement("line", _extends({}, targetLine, {
    stroke: "#1B5E9A",
    strokeWidth: 3,
    strokeLinecap: "round"
  ...
  }, formatNumber(safeValue, precision), unit), /*#__PURE__*/react.createElement("text", {
    textAnchor: "middle",
    y: 14,
    fill: textColor,
    opacity: 0.72,
  ...
  }, percent.toFixed(0), "% of max"), /*#__PURE__*/react.createElement("text", {
    x: minLabel.x,
    y: minLabel.y,
    textAnchor: "middle",
    fill: textColor,
  ...
  }, formatNumber(safeMax, 0)), /*#__PURE__*/react.createElement("g", {
  ...
  }, status.label), /*#__PURE__*/react.createElement("text", {
    x: "24",
    y: "30",
    fill: textColor,
    opacity: 0.68,
  ...
  }, "Target ", formatNumber(safeTarget, precision), unit, " (", targetDelta >= 0 ? '+' : '', formatNumber(targetDelta, precision), unit, ")"), /*#__PURE__*/react.createElement("text", {
    x: "152",
    y: "16",
    fill: "#1B5E9A",
    textAnchor: "end",
  ...
  }, "TARGET"), /*#__PURE__*/react.createElement("text", {
    x: "152",
    y: "30",
    fill: textColor,
    textAnchor: "end",
...
AdvancedRadialMeter.propTypes = {
  ...
  target: (prop_types_default()).number,
  warningAt: (prop_types_default()).number,
  criticalAt: (prop_types_default()).number,
  invertStatus: (prop_types_default()).bool,
  ...
  trackColor: (prop_types_default()).string,
  lowColor: (prop_types_default()).string,
  mediumColor: (prop_types_default()).string,
  highColor: (prop_types_default()).string,
  needleColor: (prop_types_default()).string,
...
;// ./src/main/webapp/visualizations/radial_meter_react_advanced/visualization.amd.jsx
/* eslint-disable */
...
var NS = 'display.visualizations.custom.so_BUI_pickulationts.radial_meter_react_advanced.';
...
function pickNumericDatum(rawData) {
  ...
  for (var c = 0; c < rawData.columns.length; c += 1) {
    for (var r = 0; r < rawData.columns[c].length; r += 1) {
      var n = parseNum(cellValue(rawData.columns[c][r]));
...
function readInt(config, prop, fallback) {
  var n = parseInt(readConfig(config, NS, prop, fallback), 10);
  return Number.isFinite(n) ? n : fallback;
}
function mount(el, props) {
  ...
  root.render(/*#__PURE__*/react.createElement(AdvancedRadialMeter, props));
}
/* harmony default export */ const visualization_amd = (SplunkVisualizationBase_default().extend({
  getInitialDataParams: function getInitialDataParams() {
    return {
      outputMode: (SplunkVisualizationBase_default()).ROW_MAJOR_OUTPUT_MODE,
      count: 10000
    };
  },
  ...
  updateView: function updateView(value, config) {
    mount(this.el, {
      value: value,
      ...
      backgroundColor: safeColor(readConfig(config, NS, 'backgroundColor', '#FFFFFF'), '#FFFFFF'),
      ...
      mediumColor: safeColor(readConfig(config, NS, 'mediumColor', '#DFA611'), '#DFA611'),
      highColor: safeColor(readConfig(config, NS, 'highColor', '#2E9E6F'), '#2E9E6F'),
      needleColor: safeColor(readConfig(config, NS, 'needleColor', '#243447'), '#243447'),
      width: 320,
      height: 250
    });
  },
