...
;// ./src/main/webapp/visualizations/simple_small_viz_react/visualization.amd.jsx
/* eslint-disable */




var NS = 'display.visualizations.custom.so_BUI_pickulationts.simple_small_viz_react.';
var roots = new WeakMap();
function SimpleSmallViz(_ref) {
...
function mount(el, props) {
  ...
  root.render(/*#__PURE__*/react.createElement(SimpleSmallViz, props));
}
/* harmony default export */ const visualization_amd = (SplunkVisualizationBase_default().extend({
  ...
  formatData: function formatData(rawData) {
    var series = numericSeries(rawData);
    return series.values;
  },
  updateView: function updateView(values, config) {
    var latest = values && values.length ? values[values.length - 1] : NaN;
    mount(this.el, {
      value: latest,
