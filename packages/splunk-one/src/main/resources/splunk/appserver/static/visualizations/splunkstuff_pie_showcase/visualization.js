...
define(['api/SplunkVisualizationBase'], function (SplunkVisualizationBase) {
    var NS = 'display.visualizations.custom.so_BUI_pickulationts.splunkstuff_pie_showcase.';
    var SHOWCASE_DEFAULTS = {};
    SHOWCASE_DEFAULTS[NS + 'topN'] = '5';
    SHOWCASE_DEFAULTS[NS + 'otherEnabled'] = 'true';
    SHOWCASE_DEFAULTS[NS + 'otherLabel'] = 'Other';
    SHOWCASE_DEFAULTS[NS + 'showPercent'] = 'true';
    SHOWCASE_DEFAULTS[NS + 'showDataQuality'] = 'true';
    SHOWCASE_DEFAULTS[NS + 'showTooltip'] = 'true';
    SHOWCASE_DEFAULTS[NS + 'showInspector'] = 'true';
    SHOWCASE_DEFAULTS[NS + 'showOtherBreakdown'] = 'true';
    SHOWCASE_DEFAULTS[NS + 'showSliceLabels'] = 'true';
    SHOWCASE_DEFAULTS[NS + 'sliceLabelMinPercent'] = '1';
    SHOWCASE_DEFAULTS[NS + 'legendPosition'] = 'none';
    SHOWCASE_DEFAULTS[NS + 'title'] = 'Top contributors + callouts (showcase)';
    SHOWCASE_DEFAULTS[NS + 'background'] = '#1B2A41';
    SHOWCASE_DEFAULTS[NS + 'textColor'] = '#FFFFFF';
    SHOWCASE_DEFAULTS[NS + 'palettePreset'] = 'splunk';
    ...
    function readConfig(config, prop, fallback) {
        var merged = Object.assign({}, SHOWCASE_DEFAULTS, config || {});
        var v = merged[NS + prop];
