...
define(['api/SplunkVisualizationBase'], function (SplunkVisualizationBase) {
    var NS = 'display.visualizations.custom.so_BUI_pickulationts.splunkstuff_sparkline_showcase.';
    var SHOWCASE_DEFAULTS = {};
    SHOWCASE_DEFAULTS[NS + 'goodColor'] = '#01417F';
    SHOWCASE_DEFAULTS[NS + 'badColor'] = '#DFA611';
    SHOWCASE_DEFAULTS[NS + 'textColor'] = '#FFFFFF';
    SHOWCASE_DEFAULTS[NS + 'background'] = '#0B1F3B';
    SHOWCASE_DEFAULTS[NS + 'showSparkline'] = 'true';
    SHOWCASE_DEFAULTS[NS + 'showDelta'] = 'true';
    SHOWCASE_DEFAULTS[NS + 'showHover'] = 'true';
    SHOWCASE_DEFAULTS[NS + 'showHoverAnnotation'] = 'true';
    SHOWCASE_DEFAULTS[NS + 'majorLabel'] = 'Current:';
    SHOWCASE_DEFAULTS[NS + 'deltaLabel'] = 'Change:';
    SHOWCASE_DEFAULTS[NS + 'badgeText'] = 'Demo KPI';
    SHOWCASE_DEFAULTS[NS + 'tooltipPrefix'] = 'Value';
    SHOWCASE_DEFAULTS[NS + 'sparkPointLabels'] = '0:Oldest,9:Mid,19:Latest';
    SHOWCASE_DEFAULTS[NS + 'showPointLabels'] = 'true';
